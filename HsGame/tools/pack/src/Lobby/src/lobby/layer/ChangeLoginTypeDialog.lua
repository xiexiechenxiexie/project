...
function ChangeLoginTypeDialog:_initView()
	...
	-- 弹窗背景
	local dialogBg = ccui.ImageView:create("common_little_bg.png", ccui.TextureResType.plistType)
	...
	txt1:setFontName(GameUtils.getFontName())
	...
	txt2:setFontName(GameUtils.getFontName())

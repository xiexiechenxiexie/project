...
function MyRoomInfoLayer:_createProgressItem(__data,__index )
	...
	button = self:_initItemBgtn(__data,normal,cc.p(670,44),TAG_PROGRESS,cc.p(0.5,0.5))
...
function MyRoomInfoLayer:_refreshProgressLayer( ... )
	...
	if self._roomInfoLayer == nil then
		...
		imgMyRoomTitle:setPosition(13,445)
...
function MyRoomInfoLayer:_createEndedItem( __data,__index)
	...
	local button = self:_initItemBgtn(__data,"btnLookDedtail.png",cc.p(670,44),TAG_ENDED,cc.p(0.5,0.5))
	layout:addChild(button)
	button:setTag(__index)
	button:setPressedActionEnabled(true)
	return layout
...
function MyChessInfoLayer:_createJoinChessItems( __data,__index )
	...
	local button = self:_initItemBgtn(__data,"btnLookDedtail.png",cc.p(670,44),TAG_JOIN_CHESS,cc.p(0.5,0.5))
	button:setPressedActionEnabled(true)
	button:setTag(__index)
	layout:addChild(button)
	return layout
...
function CreateRoomView:_initCreateRoomPanel( __parent )
	...
	local params = {
		...
		--授权入座
		{fontName = GameUtils.getFontName(),fontSize = 30,text = manager:findSeatDownRightString(),alignment = cc.TEXT_ALIGNMENT_CENTER,color = textColor,pos = cc.p(15,y - 62),anchorPoint = cc.p(0,0.5)},
		{fontName = GameUtils.getFontName(),fontSize = 30,text = manager:findCloseString(),alignment = cc.TEXT_ALIGNMENT_CENTER,color = valueCOloe,pos = cc.p(187,y - 62),anchorPoint = cc.p(0,0.5)},
		{fontName = GameUtils.getFontName(),fontSize = 30,text = manager:findOpenString(),alignment = cc.TEXT_ALIGNMENT_CENTER,color = valueCOloe,pos = cc.p(395,y - 62),anchorPoint = cc.p(0,0.5)},
		
		--收费入座
		{fontName = GameUtils.getFontName(),fontSize = 30,text = manager:findCostSeatDownString(),alignment = cc.TEXT_ALIGNMENT_CENTER,color = textColor,pos = cc.p(15,y - 124),anchorPoint = cc.p(0,0.5)},
		{fontName = GameUtils.getFontName(),fontSize = 30,text = manager:findYesString(),alignment = cc.TEXT_ALIGNMENT_CENTER,color = valueCOloe,pos = cc.p(187,y - 124),anchorPoint = cc.p(0,0.5)},
		{fontName = GameUtils.getFontName(),fontSize = 30,text = manager:findNoString(),alignment = cc.TEXT_ALIGNMENT_CENTER,color = valueCOloe,pos = cc.p(395,y - 124),anchorPoint = cc.p(0,0.5)},
	...
	local node = cc.exports.lib.uidisplay.createAddMinusNode({
		...
		imgMinusSize = cc.size(42,36),
		imgAdd = "btnAdd0.png",
		imgAddPrssed = "btnAdd1.png",
		imgAddDisabled = "btnAdd1.png",
		imgAddSize = cc.size(42,36),
		textureType = ccui.TextureResType.plistType,
		textSize = 30,
